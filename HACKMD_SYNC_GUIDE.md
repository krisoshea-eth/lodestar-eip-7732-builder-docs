...
| --- | --- | --- |
| Proposal note | `main` after the initial review PR is merged | `docs/proposal.md` |
| Implementation plan | `main` after the initial review PR is merged | `docs/implementation-plan.md` |
| Living technical note | `main` after the initial review PR is merged | `docs/living-technical-note.md` |
| Week 0 update | `main` after the initial review PR is merged | `docs/weekly-updates/week-00.md` |
| Week 1 update | `main` after the initial review PR is merged | `docs/weekly-updates/week-01.md` |
| Week 2 update | `main` after the initial review PR is merged | `docs/weekly-updates/week-02.md` |
| Week 3 update | `main` after the initial review PR is merged | `docs/weekly-updates/week-03.md` |
| Week 4 update | `main` after the initial review PR is merged | `docs/weekly-updates/week-04.md` |
| Week 5 update | `main` after the initial review PR is merged | `docs/weekly-updates/week-05.md` |

While the initial review PR is still open, use the branch `review/initial-docs` if you want HackMD to pull the current PR content before it is merged.
...
5. Choose the target branch:
   - Use `main` after the initial review PR is merged.
   - Use `review/initial-docs` only while reviewing the bootstrap PR.
