...
| Direct-Engine working plan | [docs/provisional-direct-engine-plan.md](docs/provisional-direct-engine-plan.md) | Confirmed working direction, current PR stack, unresolved production choices, and delivery order |
