...
- ethereum-package #1483 fixes assignment of genesis-registered Builder keys to launched Buildoor instances and documents their delayed activation until epoch 1 is finalized. Treat it as E2E/INT fixture evidence, not Lodestar Builder implementation.
