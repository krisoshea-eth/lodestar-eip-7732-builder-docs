...
**Status:** Reviewed through 11 September 2026. Nico's confirmed direct-Engine direction and the [direct-Engine working plan](direct-engine-working-plan.md) control conflicts with the historical BN-mediated sections below. API-02, TEST-01, the ledger, preference tracker, Marko's store and policy, and their contribution PRs have merged. #9958, #10054, #9979, #9980, #9982 and naming follow-up #10063 are out of draft for maintainer review, not approved for merge. #10054 still has Changes Requested on GitHub and awaits Nazar's re-review after the correction. #9979/#9980/#9982 passed critical re-review and exact-head checks; their descriptions identify the component files separately from the already-merged ledger shown in the historical diff. #9973, #9978 and #9981 remain drafts dependent on open #9958. Fork #77 is a resolved-input integration draft; fork #80 remains tied to the open payload-attributes proposal. LOD-76/77/78 own the remaining input and runtime work, without an agreed assignee. The [11 September reconciliation](reviews/2026-09-11-reconciliation.md) records exact heads, follow-ups and evidence limits.
...
| Marko-owned [LOD-69](https://linear.app/kriso/issue/LOD-69/bid-policy-base-01-add-the-initial-builder-bid-policy), [Lodestar #9974](https://github.com/ChainSafe/lodestar/pull/9974), [contribution #10](https://github.com/markolazic01/lodestar/pull/10), [#9975](https://github.com/ChainSafe/lodestar/pull/9975), and [#9976](https://github.com/ChainSafe/lodestar/pull/9976) | Policy ready with #10's merged arithmetic contribution included; broader validation remains open in LOD-64; the ledger retains winning liabilities until explicit settlement; proposer preferences are ready with event and lifecycle wiring | Review the pure foundations before final `SlotBidder` wiring; keep exact-width arithmetic and dependent-root ownership explicit |
...
| [Lodestar #9994](https://github.com/ChainSafe/lodestar/pull/9994) | Open guard prevents known genesis and pre-Gloas roots from becoming impossible payload-envelope sync targets | Track its final disposition in REL-01 and QA-01 while keeping unknown post-Gloas roots eligible for recovery |
