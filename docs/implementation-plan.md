...
**Status:** v1.0 merged on 5 August 2026. On 31 August the payload-ownership boundary was reopened by Nico's direct-Engine proof of concept, with a full branch and tracker reconciliation completed on 1 September. Nico confirmed direct Engine access as the working implementation direction on 2 September; the [provisional direct-Engine plan](provisional-direct-engine-plan.md) now controls any conflict with the BN-mediated payload, bid, cache, and reveal sections below while the supported shared versus dedicated EL topology is resolved. Current Lodestar `unstable` was `9ba9a5ce85`; #9832, #9904, #9914, and js-libp2p #3610 have merged. Draft #9958 implements the narrow PAYLOAD-SOURCE-01 extraction; fork drafts #61 and #63 contain its unwired orchestration and bounded store-core follow-ups. API-02, TEST-01, ENV-02, and SPEC-01 retain their independent scopes.
