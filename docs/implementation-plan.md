...
**Status:** v1.0 merged on 5 August 2026. Nico confirmed direct Engine access as the working direction for `packages/builder` on 2 September after the project audited his 10-commit proof-of-concept branch. The [direct-Engine working plan](direct-engine-working-plan.md) controls any conflict with the historical BN-mediated payload, bid, cache, and reveal sections below. Current Lodestar `unstable` was `d00b8296c9` at this reconciliation. #9832, #9904, #9914, #9964, #9984, and js-libp2p #3610 have merged. #9958 is ready for review; #9973 and the bid/reveal service drafts expose later review boundaries; #9970/#9974 plus Kris's contribution PRs are the active store and policy paths. Fork draft #77 proves the resolved-input bid services compose without deciding event or CLI wiring. Fork draft #80 implements the current beacon-APIs #638 safe/finalized hash shape while leaving payload-attributes trigger and deduplication open. API-02, TEST-01, ENV-02, and SPEC-01 retain their independent scopes.
...
| [consensus-specs #5594](https://github.com/ethereum/consensus-specs/pull/5594) / [Lodestar #9972](https://github.com/ChainSafe/lodestar/pull/9972) | Open specification change and ready but currently conflicting Lodestar validation change reject a bid whose block hash equals its parent hash | Reconcile #9972 after merged #9984 and track both in BID-CORE-01 and QA-01; do not duplicate Nico's validation PR |
| [Lodestar #9984](https://github.com/ChainSafe/lodestar/pull/9984) / [#9986](https://github.com/ChainSafe/lodestar/pull/9986) | Merged BN bid-validation ordering and draft shared spec-test expected-error enforcement; #9986 exposes Gloas Builder and validator sweep-index divergences | Reuse the BN validation order and route refreshed invalid-vector evidence to QA-01; neither change creates another standalone Builder service |
