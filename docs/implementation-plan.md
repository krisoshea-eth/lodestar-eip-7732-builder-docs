...
| [Lodestar #9970](https://github.com/ChainSafe/lodestar/pull/9970) / [contribution #9](https://github.com/markolazic01/lodestar/pull/9) | One active upstream PayloadStore draft plus a focused bounded-store hardening contribution | Combine the accepted behavior into #9970; do not promote the superseded fork-only store draft as a competing upstream PR |
