...
**Status:** Reviewed through 11 September 2026. Nico's confirmed direct-Engine direction and the [direct-Engine working plan](direct-engine-working-plan.md) control conflicts with the historical BN-mediated sections below. API-02, TEST-01, the ledger, preference tracker, Marko's store and policy, and their contribution PRs have merged. #9958, #10054, #9979, #9980 and #9982 are ready for review. The latter three passed critical re-review and exact-head checks; their descriptions identify the component files separately from the already-merged ledger shown in the historical diff. #9973, #9978 and #9981 remain drafts dependent on open #9958. Fork #77 is a resolved-input integration draft; fork #80 remains tied to the open payload-attributes proposal. LOD-76/77/78 own the remaining input and runtime work, without an agreed assignee. The [11 September reconciliation](reviews/2026-09-11-reconciliation.md) records exact heads, follow-ups and evidence limits.
