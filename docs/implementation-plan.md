...
**Status:** Reviewed through 12 September 2026. Nico's confirmed direct-Engine direction and the [direct-Engine working plan](direct-engine-working-plan.md) control conflicts with the historical BN-mediated sections below. API-02, TEST-01, the ledger, preference tracker, Marko's store and policy, and their contribution PRs have merged. #9958, #10054, #9979, #9980, #9982, naming follow-up #10063, shared events #10064 and API cancellation #10065 are out of draft for maintainer review, not approved for merge. #10054 still has Changes Requested on GitHub and awaits Nazar's re-review after the correction. #9979/#9980/#9982 passed critical re-review and exact-head checks; their descriptions identify the component files separately from the already-merged ledger shown in the historical diff. #9973, #9978 and #9981 remain drafts dependent on open #9958. Fork #77 is a resolved-input integration draft; fork #80 remains tied to the open payload-attributes proposal. LOD-76/77/78 own the remaining input and runtime work, without an agreed assignee. The [12 September reconciliation](reviews/2026-09-12-reconciliation.md) records exact heads, follow-ups and evidence limits.
...
| `D-13` | Reveal cache and stale work | Use a Builder-owned bounded in-memory payload store for the first loop; retain exact reveal material until reveal or expiry and preserve first-write identity | Store before publication, cancel stale build work, and remove material only on explicit lifecycle transitions. Persistence and restart recovery follow after the honest in-memory loop works |
...
| [Lodestar #9978](https://github.com/ChainSafe/lodestar/pull/9978) / [#9979](https://github.com/ChainSafe/lodestar/pull/9979) / [#9980](https://github.com/ChainSafe/lodestar/pull/9980) / [#9981](https://github.com/ChainSafe/lodestar/pull/9981) / [#9982](https://github.com/ChainSafe/lodestar/pull/9982) | Draft bid assembly/publication and selection/envelope service boundaries; #9979 preserves Heze bid typing, #9981 binds the retained parent Beacon root, and #9982 separates reveal reservation from successful publication | Keep as integration evidence, not five accepted abstractions. Consider two grouped review units around the bid path and selection/reveal path after foundation feedback |
