...
The board preserves completed foundation work. API-02, TEST-01, BID-LEDGER-01, PREF-01, STORE-WIRING-01 and BID-POLICY-BASE-01 are now **Done** for their merged scopes. PAYLOAD-SOURCE-01, BID-PUBLISH-01, SELECT-MATCH-01 and REV-PUBLISH-01 are **In Review**; the source-dependent service drafts and resolved-input integration remain in progress. ENV-02 remains **In Review** pending independent reproduction, with outreach paused. LOD-76/77/78 and the newly extracted runtime follow-ups remain backlog and unassigned. Landed prerequisites and pure helpers narrow a consuming issue but do not automatically complete its integrated outcome. Linear and its GitHub mirrors carry the current per-issue status.
