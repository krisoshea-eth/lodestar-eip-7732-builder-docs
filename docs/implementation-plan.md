...
**Current evidence:** Upstream [Lodestar #9931](https://github.com/ChainSafe/lodestar/pull/9931) is the review artifact at head `1d2380582c`. It changes five Builder files and includes 25 focused observer tests, lifecycle wiring coverage, package type-check, lint, build, and build-import evidence. The real-BN event-to-block and connected/interrupted-stream shutdown evidence is stored under ENV-02; issue closure still requires the independent environment reproduction defined there.
