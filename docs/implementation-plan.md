...
**Status:** Reviewed through 11 September 2026. Nico's confirmed direct-Engine direction and the [direct-Engine working plan](direct-engine-working-plan.md) control conflicts with the historical BN-mediated sections below. API-02, TEST-01, the ledger, preference tracker, Marko's store and policy, and their contribution PRs have merged. #9958 and #10054 are ready for review; the remaining service PRs remain drafts. The ledger-dependent drafts no longer wait for #9975 to merge, but their historical diffs still need a clear review presentation. Fork #77 is a resolved-input integration draft; fork #80 remains tied to the open payload-attributes proposal. LOD-76/77/78 own the remaining input and runtime work, without an agreed assignee. The [11 September reconciliation](reviews/2026-09-11-reconciliation.md) records exact heads, follow-ups and evidence limits.
...
The board preserves completed foundation work. API-02, TEST-01, BID-LEDGER-01, PREF-01, STORE-WIRING-01 and BID-POLICY-BASE-01 are now **Done** for their merged scopes. PAYLOAD-SOURCE-01 remains **In review**; the dependent service drafts and resolved-input integration remain in progress. ENV-02 remains **In review** pending independent reproduction, with outreach paused. LOD-76/77/78 and the newly extracted runtime follow-ups remain backlog and unassigned. Landed prerequisites and pure helpers narrow a consuming issue but do not automatically complete its integrated outcome. Linear and its GitHub mirrors carry the current per-issue status.
