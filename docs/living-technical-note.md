...
| Architecture reconciliation | [Direct-Engine working plan](direct-engine-working-plan.md), confirmed direction with the PR/board audit refreshed on 10 September 2026; supersedes the historical BN-mediated payload and reveal design while production EL topology remains open |
