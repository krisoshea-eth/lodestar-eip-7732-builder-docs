...
| Epoch-boundary head freshness | [#9864](https://github.com/ChainSafe/lodestar/pull/9864), [#9813](https://github.com/ChainSafe/lodestar/pull/9813) | #9864 now recomputes fork-choice head after checkpoint pull-up; NC's earlier recompute-before-proposer-boost-check alternative remains open | Treat #9864 as the current baseline, monitor #9813's disposition, and cover the landed transition in `BID-01` head-change tests |
...
| [#9864](https://github.com/ChainSafe/lodestar/pull/9864) / [#9813](https://github.com/ChainSafe/lodestar/pull/9813) | #9864 merged; #9813 open | Landed epoch-boundary head recomputation plus the still-open earlier alternative whose disposition must be checked |
