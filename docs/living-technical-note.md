...
| Architecture reconciliation | [Direct-Engine working plan](direct-engine-working-plan.md), confirmed direction with the PR/board audit refreshed on 10 September 2026; controls conflicts with the historical BN-mediated payload and reveal design while production EL topology remains open |
...
| Last reconciliation | September 10, 2026: [current reconciliation](reviews/2026-09-10-reconciliation.md), amended preference lifecycle, merged ENV-03, upstream input/recovery watches and board-status corrections. No fresh devnet or independent reproduction result is implied |
...
| 2026-09-03 | Component safety boundaries, corrected 10 September | **Preserve exact identity and retry state before runtime wiring** | #9973 rejects conflicting reuse of a job ID; #9976 now uses read-only retained values without copying; accepted #9970 contribution #9 adds tests only, not material isolation; #9981 verifies the retained parent Beacon root; #9975/#9982 separate exact reveal reservation from successful publication; #9979 preserves Heze bid fields |
