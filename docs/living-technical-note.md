...
| Board setup | Done | 70 tracked Linear issues with 70 matching GitHub issue mirrors, milestones, scope labels, cycles, saved views, and a public GitHub Project mirror. GitHub Project custom-field verification requires refreshed `read:project` authorization |
