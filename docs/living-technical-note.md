...
| [#9968](https://github.com/ChainSafe/lodestar/pull/9968) | Approved, checks passing | Records late canonical-block imports with logs and a metric. Reuse it in QA-01 to distinguish local BN import delay from Builder selection or reveal delay |
...
| [#9972](https://github.com/ChainSafe/lodestar/pull/9972) | Approved and mergeable; spec-test job failing | Implements consensus-specs #5594 bid validation; track its final disposition and reuse it rather than duplicating the check |
