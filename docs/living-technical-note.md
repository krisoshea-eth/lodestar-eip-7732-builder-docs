...
| 2026-09-03 | Component safety boundaries | **Preserve exact identity and retry state before runtime wiring** | #9973 rejects conflicting reuse of a job ID; #9976 isolates retained preferences from mutation; the #9970 hardening contribution isolates retained payload material; #9981 verifies the retained parent Beacon root; #9975/#9982 separate exact reveal reservation from successful publication; #9979 preserves Heze bid fields |
