...
| Last reconciliation | September 2, 2026: all 42 changed files in `nflaig/builder` at `99fd8fa9ad`, Lodestar `unstable` at `9ba9a5ce85`, current direct-Engine drafts, the BASELINE-01 capability matrix, all 52 Linear issues, and the GitHub mirror |
