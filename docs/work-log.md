...
- Recorded merged Lodestar #9984 and #9986 as BN validation and shared spec-test changes. #9972 is approved and mergeable, with its spec-test and benchmark jobs currently failing. None overlaps the current Builder service drafts.
