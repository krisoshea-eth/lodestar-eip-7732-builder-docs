...
- Refreshed API-02 fork draft [#48](https://github.com/krisoshea-eth/lodestar/pull/48) from stale head `1aae68a26f` to current Lodestar `unstable` `157b2b2a96` through incremental merge `dccc66f368`, without rebasing or force-pushing after review began.
...
- Recorded open Lodestar Builder API draft [#9832](https://github.com/ChainSafe/lodestar/pull/9832) as a direct BN-01 input, open SSE resilience [#9872](https://github.com/ChainSafe/lodestar/pull/9872), native PTC sampling [#9903](https://github.com/ChainSafe/lodestar/pull/9903), and bounded envelope caching [#9904](https://github.com/ChainSafe/lodestar/pull/9904) as current watches. Live status also corrected a monitor-table error: #9736 remains open, draft, and conflicting rather than merged.
